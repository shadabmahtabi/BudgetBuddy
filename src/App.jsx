...
const App = () => {
  ...
  const UpdateHandler = (e) => {
    ...
    if (updatedStatement.type === 'Income') {
      totalAmount = (Number(totalIncome) - Number(oldStatement.amount)) + Number(updatedStatement.amount);
      ...
      totalAmount = (Number(totalExpense) - Number(oldStatement.amount)) + Number(updatedStatement.amount);
  ...
  return (
    <div className={css.appMain}>
      ...
      <Form statements={statements}
        ...
        setDescription={setDescription} date={date}
        setDate={setDate}
